...
import { type TrackReference, useTrackVolume, useVoiceAssistant } from '@livekit/components-react';
...
const MotionCentralOrb = motion.create(
  dynamic(() => import('@/components/agents-ui/central-orb').then(mod => mod.CentralOrb), { ssr: false })
);
